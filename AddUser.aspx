<%@ Page Title="" Language="C#" MasterPageFile="~/AdminProfile.master" AutoEventWireup="true" CodeFile="AddUser.aspx.cs" Inherits="AddUser" %>
        ...
        <div style="margin-left:60px">
          <div class="row collapse">
            ...
            <div class="small-10  columns">
              ...
              <asp:TextBox Id="username" runat="server" placeholder="username" EnableTheming="True" ValidationGroup="logout" />
          ...
          <div class="row collapse">
            ...
            <div class="small-10 columns ">
             ...
             <div class="small-10 columns ">
              ...
              <asp:Button ID="btnAddUser" Text="Sign Up" runat="server" CssClass="button" OnClick="btnAddUser_Click" />
